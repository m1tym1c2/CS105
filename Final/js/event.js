...
import { promptAndDownload } from './main.js';
...
const audio = new Audio('audio/mtp.mp3');
audio.loop = true;
...
tools.forEach((tool, index) => {
	...
	else if (tool.className.includes("log"))
		tool.addEventListener("click", promptAndDownload)
	else
