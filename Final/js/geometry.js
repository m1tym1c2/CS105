...
function scale_geometry(geometry, scale) {
    geometry.scale(scale, scale, scale);
}

const scaleFactor = 50 / 100;  // Tỷ lệ thu nhỏ

function set_position_y(mesh, height) {
    mesh.position.y = height / 2;
}

function create_cube(typeMaterial = "Solid") {
    const cubeGeometry = new THREE.BoxGeometry(3, 3, 3, 10, 10, 10);
    scale_geometry(cubeGeometry, scaleFactor);
    const cubeMesh = get_material(cubeGeometry, typeMaterial);
    set_position_y(cubeMesh, cubeGeometry.parameters.height);
...
function create_sphere(typeMaterial = "Solid") {
    ...
    scale_geometry(geometry, scaleFactor);
    const sphere = get_material(geometry, typeMaterial);
    set_position_y(sphere, geometry.parameters.radius * 2);
...
function create_cone(typeMaterial = "Solid") {
    ...
    set_position_y(cone, geometry.parameters.height);
...
function create_cylinder(typeMaterial = "Solid") {
    ...
    set_position_y(cyclinder, geometry.parameters.height);
...
function create_torus(typeMaterial = "Solid") {
    ...
    set_position_y(torus, geometry.parameters.tube * 2); // Adjust as necessary
...
function create_torus_knot(typeMaterial = "Solid") {
    ...
    set_position_y(torus_knot, geometry.parameters.tube * 2); // Adjust as necessary
    initUserData(torus_knot, "Torus Knot", typeMaterial);
    return torus_knot;
}

function create_teapot(typeMaterial = "Solid") {
	const geometry = new TeapotBufferGeometry(1, 2);
...
function create_tube(typeMaterial) {
    ...
    set_position_y(tube, geometry.parameters.radius * 2); // Adjust as necessary
...
function create_octahedron(typeMaterial) {
    ...
    set_position_y(octahedron, geometry.parameters.radius * 2);
...
function create_tetrahedron(typeMaterial) {
    ...
    set_position_y(tetrahedron, geometry.parameters.radius * 2);
...
function create_dodecahedron(typeMaterial) {
    ...
    set_position_y(dodecahedron, geometry.parameters.radius * 2);
...
function create_icosahedron(typeMaterial) {
    ...
    set_position_y(icosahedron, geometry.parameters.radius * 2);
